...
* **docker-compose-up [-e CLIENTS=1]**: Inicializa el ambiente de desarrollo (buildear docker images del servidor y cliente, inicializar la red a utilizar por docker, etc.) y arranca los containers (1 server, CLIENTS clientes) de las aplicaciones que componen el proyecto.
